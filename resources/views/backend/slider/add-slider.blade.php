            ...
            <div class="row">
              ...
              <section class="col-md-12">
                ...
                <div class="card">
                  ...
                  <!-- /.card-header -->
                  <div class="card-body">
                   <form action="{{route('sliders.store')}}" enctype="multipart/form-data" method="POST" id="myForm">
                       @csrf
                       ...
                       <div class="form-group col-md-4"> 
                          ...
                          <div class="form-group col-md-4"> 
                            ...
                            <div class="form-group col-md-4"> 
                                ...
                                url('/upload/user_images/'.$editData->image):url('/upload/nofound.png')}}" style="width:150px;height:160px; border:1px solid #000" alt="">
                           </div>
